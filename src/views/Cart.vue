    ...
    <div class="container">
      <div class="cart">
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" v-bind:class="{'btn--dis':checkedCount==0}" @click="checkOut">选好了</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-else class="cartContent">
          <img src="../assets/cartEmpty.jpeg" style="margin-left:350px;width:500px;height:400px;"/>
          <span class="desc">就算工作再忙～也别忘了好好对待自己～</span>
          <span class="desc1">去<a href="/" style="text-decoration:underline;color:red;">首页</a>逛逛～</span>
        </div>
      </div>
    </div>

    <Modal :mdShow="modalConfirm" @close="closeModal">
      <p slot="message">你确认要移除此件商品吗?</p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="delCart">确认移除</a>
        <a class="btn btn--m btn--red" href="javascript:;" @click="modalConfirm = false">关闭</a>
      </div>
    </Modal>
    <nav-footer style="margin-top:195px;"></nav-footer>
  </div>
</template>
        ...
        editCart(flag,item){
            ...
            axios.post("/users/cartEdit",{
              ...
              checked:item.checked
                ...
                let res = response.data;
                if(res.status=="0"){
                  this.$store.commit("updateCartCount",flag=="add"?1:0);
                  this.$store.commit("updateCartCount",flag=="minu"?-1:0);
                }
            })
        },
        toggleCheckAll(){
