<template>
  <div>
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="productInfo" label="订单商品" width="200">
      </el-table-column>
      <el-table-column prop="orderTotal" label="订单总额" width="100">
      </el-table-column>
