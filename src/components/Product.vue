...
<template>
  <div>
    <el-table v-loading="loading" :data="tableData5" style="width: 100%">
    ...
    <el-button
      type="primary"
      style="margin-left: 900px; margin-top: 30px"
      @click="addProduct"
      >新增产品<i class="el-icon-upload el-icon--right"></i
    ></el-button>
    <!--编辑界面-->
...
export default {
  ...
  methods: {
    init() {
      axios.post("/adminUser/AllProduct", {}).then((res) => {
        console.log(res);
        this.loading = false;
