    ...
    <div class="container">
      <div class="checkout-order">
            ...
            <ul class="cart-item-list">
              <li v-for="(item, index) in orderList" :key="item.orderId">
                ...
                <div class="cart-tab-4">
                  <div class="item-price-total" v-if="item.orderStatus == '1'">
                    已付款，待发货
                  </div>
                  <div class="item-price-total" v-if="item.orderStatus == '2'">
                    已发货
                    <img
                  ...
                  <div class="item-price-total" v-if="item.orderStatus == '3'">
                    已签收，<a
                      href="javascript:;"
        ...
        <div
          ...
          v-bind:class="{ 'md-show': DetailModalFlag }"
        >
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">订单详情</div>
              <button class="md-close" @click="DetailModalFlag = false">
                Close
              </button>
            </div>
            <div style="font-size: 16px">订单编号:</div>
            <span style="color: #1296db">{{ orderid }}</span>
            <div style="font-size: 16px">下单时间:</div>
            <span style="color: #1296db">{{ date }}</span>
            <div style="font-size: 16px">收货信息:</div>
            <span style="margin-left: 20px"
              >收货人姓名:
              <p style="color: #d81e06; margin-left: 30px">
                {{ username }}
              </p></span
            ...
            >
            <div style="font-size: 16px">实付金额:</div>
            <span style="color: orange"
              >{{ ordertotal | currency("￥") }}元</span
            >
          </div>
        </div>
        ...
        <div
          class="md-modal modal-msg md-modal-transition"
          v-bind:class="{ 'md-show': parcelModalFlag }"
        >
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">物流详情</div>
              <button class="md-close" @click="parcelModalFlag = false">
                Close
              </button>
            </div>
            <div class="track-rcol">
              <div class="track-list">
                <ul>
                  <li class="first">
                    <i class="node-icon"></i>
                    <span class="time">2021-04-23 02:07:15</span>
                    <span class="txt">商家正通知快递揽件～</span>
                  </li>
                  <li>
                    <i class="node-icon"></i>
                    <span class="time">2021-04-23 10:32:15</span>
                    <span class="txt"
                      >您的商品已经出库，开始进入分发中心～</span
                    >
                  </li>
                  <li>
                    <i class="node-icon"></i>
                    <span class="time">2021-04-24 07:07:15</span>
                    <span class="txt">您的商品已经在运输的路上～</span>
                  </li>
                  <li>
                    <i class="node-icon"></i>
                    <span class="time">2021-04-25 12:02:15</span>
                    <span class="txt">您的商品已到达分拣点～</span>
                  </li>
                  <li>
                    <i class="node-icon"></i>
                    <span class="time">2021-04-25 13:04:15</span>
                    <span class="txt">您的商品正在派送中</span><br />
                    <span class="txt" style="margin-left: 163px"
                      >配送员电话:12345678999</span
                    >
                  </li>
                  <li>
                    <i class="node-icon"></i>
                    <span class="time">2021-04-25 18:07:15</span>
                    <span class="txt">感谢您在乐购购物，欢迎您再次光临！</span>
                  </li>
                </ul>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    toEva(index) {
      ...
      this.$router.push({
        name: "EvaluationCen",
        params: { orderId: this.orderList[this.checkIndex].orderId },
      });
    },
    show() {
