...
<template>
  <header class="header">
      ...
      <div class="navbar-right-container" style="display: flex">
        <div class="navbar-menu-container">
          ...
          <a
            ...
            class="navbar-link"
            @click="adminloginModalFlag = true"
            v-if="!nickName"
            >商家登录</a
          >
          <a
          ...
          <a
            ...
            >注销</a
          >
          <a href="/#/orderContent" class="navbar-link" v-if="nickName"
            >我的订单</a
          >
    ...
    >
      <div class="md-modal-inner">
        <div class="md-top">
          ...
          <button
            class="md-close"
            @click="(loginModalFlag = false), (errorTip = false)"
          >
            Close
          </button>
        </div>
    ...
    <div
      class="md-modal modal-msg md-modal-transition"
      v-bind:class="{ 'md-show': adminloginModalFlag }"
    >
      <div class="md-modal-inner">
        <div class="md-top">
          ...
          <button
            class="md-close"
            @click="(adminloginModalFlag = false), (errorTip = false)"
          >
            Close
          </button>
        </div>
        ...
        <div class="md-content">
          ...
          <div class="login-wrap">
            <a href="javascript:;" class="btn-login" @click="adminLogin"
              >登 录</a
            >
          </div>
        </div>
    ...
    <div
      class="md-modal modal-msg md-modal-transition"
      v-bind:class="{ 'md-show': registModalFlag }"
    >
      <div class="md-modal-inner">
        <div class="md-top">
          ...
          <button
            class="md-close"
            @click="
              (registModalFlag = false), (errorTip = false), (errorTip2 = false)
            "
          >
            Close
          </button>
        ...
        <div class="md-content">
          <div class="confirm-tips">
            ...
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTip1"
                >该用户名已被注册，请重新输入</span
              >
            </div>
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTip2"
                >两次输入密码不一致，请重新输入</span
              >
            </div>
            <ul>
              <li class="regi_form_input">
          ...
          <div class="login-wrap">
            <a href="javascript:;" class="btn-login" @click="regist"
              >立即注册</a
            >
          </div>
        </div>
    ...
    <div
      class="md-overlay"
      v-if="adminloginModalFlag"
      @click="adminloginModalFlag = false"
    ></div>
    <div
      class="md-overlay"
      v-if="registModalFlag"
      @click="registModalFlag = false"
    ></div>
  </header>
</template>
