                    ...
                    <div class="login_con" v-show="num == 1">
                        <form>
                            <div>
                                ...
                                <input type="text" name="" v-model="userName" placeholder="请输入会员帐号">
                                ...
                                <p class="tips" v-show="show">会员帐号不能为空</p>
                            </div>
                            <div>
                                <label for="user_pwd">密码</label>
                                <input type="password" name="" v-model="password" placeholder="请输入账户密码">
                                ...
                                <p class="tips" v-show="passshow">会员密码不能为空</p>
                            </div>
