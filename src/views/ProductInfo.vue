    ...
    <div class="container">
      ...
      <div class="shopdetails">
        ...
        <div class="centerbox">
          ...
          <p class="Aprice">
            价格：<samp>￥{{ this.Oprice }}</samp>
          </p>
          <p class="price">
            促销价：<samp>￥{{ this.good.salePrice }}</samp>
          </p>
          <p class="youhui">店铺优惠：<samp>暂无优惠</samp></p>
          <p class="kefu">客服：</p>
          <div class="clear"></div>
          <!-- <p class="chima">尺寸：</p> -->
          <p class="buy">
            <a href="javascript:void(0);" id="firstbuy" @click="buy">立即购买</a
            ><a href="javascript:void(0);" @click="addCart(productId)"
              >加入购物车</a
            >
          </p>
          <div class="clear"></div>
          <div class="fenx">
            <a href="#"><img src="../assets/xihuan.jpg" /></a>
          </div>
          <p class="fuwu">服务承诺：</p>
          <p class="pay">支付方式：</p>
        </div>
        ...
        <div class="tabbedPanels">
          ...
          <div class="panelContainer">
            ...
            <div class="panel" v-show="num == 2">
              ...
              <p class="judge">
                全部评价({{ count }})<span>晒图({{ count }})</span>
              </p>
              <ul v-if="this.mesList.length > 0">
                <li v-for="item in mesList">
                  <div class="judge01">
                    <div class="idimg">
                      <img src="../assets/user_ava.png" />
                    </div>
                    <div class="write">
                      <p class="idname">
                        {{ item.userName }}
    ...
    init() {
      ...
      axios
        ...
        .then((res) => {
          ...
          this.good = data;
          this.Oprice = this.good.salePrice + 10;
          this.productName = this.good.productName;
          this.image = "/static" + "/" + this.good.productImage;
        });
      axios
        .post("/goods/getUsermes", {
          params: param,
        })
        .then((res) => {
          console.log(res);
